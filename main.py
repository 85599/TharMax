...
def login_clicked(e):
    ...
    if result and current_password == result[0]:
        ...
        text += '\nYou would now be directed to your TharMax account on pressing OK button.'
...
def show_register_info(username, balance):
    ...
    text += ' \n You can now login to continue using TharMax Virtual Trading Platform.'
...
login_text = """
            Welcome to the TharMax Trading Application, use this at your own risks because Market is risky.
